...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x04, 0xAC, 0x76};
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01};
uint8_t nodeAppKey[16] = {0x3A, 0x3A, 0x6B, 0x57, 0xE6, 0xCC, 0xC5, 0x28, 0x28, 0x69, 0x08, 0x14, 0x77, 0x38, 0xFB, 0x20};
