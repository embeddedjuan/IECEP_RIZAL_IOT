...
uint8_t nodeDeviceEUI[8] = {0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x04, 0x9D, 0xEA};
uint8_t nodeAppEUI[8] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01 };
uint8_t nodeAppKey[16] = {0xC3, 0x49, 0x32, 0x48, 0x8E, 0x37, 0x85, 0x1D, 0x1F, 0x19, 0x04, 0x5D, 0xD3, 0xAE, 0xE9, 0xE9};
